...
with ff_Report:
    ...
    # The report printer will also catch errors and print them in the html file
    a = 1/0
    # Alternatively do not use the *with* function, and just run 
    # >> ff_Report.save_html() # at the end...